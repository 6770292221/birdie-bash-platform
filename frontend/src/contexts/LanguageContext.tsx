...
const translations = {
  th: {
    ...
    'warning.cancellation_penalty': 'คุณมีค่าปรับ',
    'warning.cancellation_penalty_desc': 'การยกเลิกการลงทะเบียนครั้งนี้มีค่าปรับตามกฎของกิจกรรม กรุณาติดต่อผู้จัดกิจกรรมเพื่อชำระค่าปรับ',
  ...
  en: {
    ...
    'warning.cancellation_penalty': 'You Have a Penalty Fee',
    'warning.cancellation_penalty_desc': 'This cancellation incurs a penalty fee according to the event rules. Please contact the event organizer to pay the penalty fee.',
    'success.saved': 'Saved',
